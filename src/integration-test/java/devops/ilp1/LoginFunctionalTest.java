...
public class LoginFunctionalTest {
	...
	public void loginSuccess() {
        driver.get("http://localhost:6080/ILP_HCLstore");
	...
	public void registrationSuccess() {
        driver.get("http://localhost:6080/ILP_HCLstore/register.jsp");
        ...
        button.click();
        assertTrue(driver.getPageSource().contains("HCL Store"));
	}
	
	@Test
	public void forgotPasswordSuccess() {
        driver.get("http://localhost:6080/ILP_HCLstore/forgotpassword.jsp");      
